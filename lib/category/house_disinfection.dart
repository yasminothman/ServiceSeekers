...
class HouseDisinfectionPage extends StatefulWidget {
  @override
  State<HouseDisinfectionPage> createState() => _HouseDisinfectionPageState();
}

class _HouseDisinfectionPageState extends State<HouseDisinfectionPage> {
  List<Map<String, dynamic>> cartItems = [];
  String selectedCat = 'housedisinfection';
