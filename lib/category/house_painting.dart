...
class HousePaintingPage extends StatefulWidget {
  @override
  State<HousePaintingPage> createState() => _HousePaintingPageState();
}

class _HousePaintingPageState extends State<HousePaintingPage> {
  List<Map<String, dynamic>> cartItems = [];
  String selectedCat = 'housepainting';
